...
jQuery(document).ready(function(){
	jQuery('.content_toggle').click(function(){
		...
		if (jQuery('.content_block').hasClass('hide')) {
			jQuery('.content_toggle').html('читать');
		} else {
...
function sliderInitt() {
  ...
  slidesToScroll: 1,
    ...
    jQuery(this).on('afterChange', function(event, slick, currentSlide){
      $sliderParent.find('.slides-numbers .active').html(helperss.addZeros(currentSlide + 1));
    });

    var sliderItemsNum = jQuery(this).find('.slick-slide').not('.slick-cloned').length;
    $sliderParent.find('.slides-numbers .total').html(helperss.addZeros(sliderItemsNum));
...
jQuery(".navbar-toggler").click( function() {
	jQuery(".navbar-toggler").toggleClass("navbar-toggler-close");
});
jQuery("h3.widget-title-hid").click( function() {
  jQuery(".menu-kategorii-statej-container").toggleClass("menu-kategorii-statej-container-open");
});
jQuery("h3.widget-title-hid").click( function() {
  jQuery("h3.widget-title-hid").toggleClass("title-catalog-active");
});

jQuery(document).ready(function($){
if($('.content-pov ul').find('li').length > 5){
...
jQuery(window).load(function(){
		...
		jQuery(".collapse").on('show.bs.collapse', function(){
			jQuery(this).parent().find(".card-header .btn i").html("add");
